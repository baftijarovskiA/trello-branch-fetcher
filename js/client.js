              ...
              items: [
                {
                  ...
                  callback: function (t, opts) {
                    return t.navigate({
                      url: "https://trello.com/b/Yc8MHkrS/trello-power-up-test-board?menu=filter&filter=label:green",
                    });
                  },
                },
                {
                  ...
                  callback: function (t, opts) {
                    return t.navigate({
                      url: "https://trello.com/b/K3k1CNLD/holiday-meal-planning?menu=filter&filter=label:Sides",
                    });
                  },
                },
                {
